...
const Card = styled(motion.div)(({ selected }) => [
...
const Slider = ({ title, value, mesureUnit, ...rest }) => (
  <div>
...
const Divider = () => <div tw="w-48 mx-auto border-t-2  border-blue-200"></div>;
    ...
    >
      ...
      {selected && (
        <>
          ...
          <motion.div tw="px-8" {...sliderAnimation}>
            <input
              className="slider-thumb"
              type="range"
              min={1}
